...
<div class="grid gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 grid-cards">
    <section class="rounded-2xl bg-linear-to-br from-white to-slate-50 dark:from-slate-800 dark:to-slate-900 p-4 md:p-5 shadow-md border border-slate-200 dark:border-slate-700 transition-all duration-300 hover:shadow-lg hover:border-slate-300 dark:hover:border-slate-600 mobile-collapse">
    ...
    <section class="rounded-2xl bg-gradient-to-br from-white to-slate-50 dark:from-slate-800 dark:to-slate-900 p-4 md:p-5 shadow-md border border-slate-200 dark:border-slate-700 mobile-collapse">
        ...
        <div class="mt-4 space-y-3 text-sm">
            <div class="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                ...
                <span class="font-bold text-slate-900 dark:text-slate-100"><?= $apartamento ?></span>
            </div>
            <div class="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                <span class="flex items-center gap-2 font-medium text-slate-700 dark:text-slate-200">
                ...
                <span class="font-bold text-slate-900 dark:text-slate-100"><?= $moradia ?></span>
            </div>
            <div class="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                <span class="flex items-center gap-2 font-medium text-slate-700 dark:text-slate-200">
                ...
                <span class="font-bold text-slate-900 dark:text-slate-100"><?= $escritorio ?></span>
            </div>
            <div class="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                <span class="flex items-center gap-2 font-medium text-slate-700 dark:text-slate-200">
                ...
                <span class="font-bold text-slate-900 dark:text-slate-100"><?= $comercial ?></span>
            </div>
        </div>
