<div class="w-full bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
    <div class="flex flex-col md:flex-row gap-0">
        <div class="relative bg-gray-200 w-full md:w-80 lg:w-90 min-h-68 card-image-mobile-full shrink-0 flex items-center justify-center group">
